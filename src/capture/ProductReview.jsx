...
export default function ProductReview({draft,change,onInspect,onPhotos,onUploadEdited,onUploadVideos,onGenerate,onAutoEnrich,onStageLifestyle,onEnhancePhoto,onDeletePhoto,enrichState={active:false,percent:0,step:0,message:''},busy,issues,onMatch,products,search,setSearch,onCompare,dirty}){
